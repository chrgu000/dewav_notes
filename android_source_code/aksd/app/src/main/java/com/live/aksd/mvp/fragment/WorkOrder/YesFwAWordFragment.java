...
public class YesFwAWordFragment extends BaseFragment<IAWordView, AWordPresenter> implements IAWordView {
    ...
    public static YesFwAWordFragment newInstance() {
        Bundle args = new Bundle();
        YesFwAWordFragment fragment = new YesFwAWordFragment();
    ...
    private void refresh() {
        ...
        map.put("type", "worker_accept_service");
        map.put("page", page + "");
