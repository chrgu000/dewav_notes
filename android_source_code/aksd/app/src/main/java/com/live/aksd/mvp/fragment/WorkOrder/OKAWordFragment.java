...
public class OKAWordFragment extends BaseFragment<IAWordView, AWordPresenter> implements IAWordView {
    ...
    public static OKAWordFragment newInstance() {

        Bundle args = new Bundle();
        OKAWordFragment fragment = new OKAWordFragment();
