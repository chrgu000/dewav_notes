...
public class WaitWordAdapter extends RecyclerArrayAdapter<MasterBean> {


    public WaitWordAdapter(Context context, List<MasterBean> objects) {
    ...
    public class ListBeanViewHolder extends BaseViewHolder<MasterBean> {
        ...
        public ListBeanViewHolder(ViewGroup parent) {
            super(parent, R.layout.fragment_worder_wait);
