    ...
    public static class Builder {
        ...
        public CustomDialog create() {
            ...
            if (message != null) {
                ...
                // ((LinearLayout) layout.findViewById(R.id.umeng_update_content)).removeAllViews();
                // ((LinearLayout) layout.findViewById(R.id.umeng_update_content)).addView(contentView, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
            }
            if (title != null) {
        ...
        public CustomDialog onCreate() {
            ...
            // instantiate the dialog with the custom Theme
            final CustomDialog dialog = new CustomDialog(context, R.style.dialog_exit_live);
            View layout = inflater.inflate(R.layout.select_dialog_new, null);
            dialog.addContentView(layout, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        ...
        public CustomDialog onCreateOne() {
            ...
            if (messageNew != null) {
                ((TextView) layout.findViewById(R.id.content)).setText(messageNew);
            }
