...
public class BitmapLockScrActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
 	...
 	startService(new Intent(BitmapLockScrActivity.this,BitmapLockService.class));
        if(isFirstIn==true)
        {
        	Toast.makeText(mContext,getString(R.string.lock_scr_ini), 2000).show();
        	isFirstIn=false;
        	this.finish();
...
public int floatstreamVolume=0;
	...
	private void playSond()
	{
			...
			if(mediaPlayerLock==null)
			{
			   ...
			   // mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, maxVolume, 0);
				...
				mediaPlayerLock.setOnCompletionListener(  
    ...
    private void showObsolute(){  
		...
		if(imageIndex<0)
			imageIndex=0;
		//imageView.setImageResource(R.drawable.bslockbg);
		...
		voltageParams1 = new AbsoluteLayout.LayoutParams(voltageW,voltageH,voltageX,voltageY);
		...
		timeTextView.setTextScaleX((float)1);
		timeTextView.setTextColor(Color.WHITE);
		timeParams1 = new AbsoluteLayout.LayoutParams(mTimeW,mTimeH,mTimeX,mTimeY);
		...
		*/
		...
		dateParams1 = new AbsoluteLayout.LayoutParams(mDateW,mDateH,mDateX,mDateY);
    ...
    private void setTimeImageResource()
    {
      ...
      timeImageView3.setImageResource(R.drawable.tm);
    ...
    private void setTimeImage()
    {
    	...
    	timeImageParams1 = new AbsoluteLayout.LayoutParams(mTimeW,mTimeH,mTimeX,mTimeY);
    	timeImageParams2 = new AbsoluteLayout.LayoutParams(mTimeW,mTimeH,mTimeX+mTimeW,mTimeY);
    	timeImageParams3 = new AbsoluteLayout.LayoutParams(mTimeW,mTimeH,mTimeX+2*mTimeW,mTimeY);
    	timeImageParams4 = new AbsoluteLayout.LayoutParams(mTimeW,mTimeH,mTimeX+3*mTimeW,mTimeY);
    	timeImageParams5 = new AbsoluteLayout.LayoutParams(mTimeW,mTimeH,mTimeX+4*mTimeW,mTimeY);
...
private void redrawStatic() {
			...
			/*
			timeParams1.x=mTimeX;
			timeParams1.y=mTimeY;
	...
	private void handleActionUpEvent(MotionEvent event) {
		...
		if((moveX>MOVE_X_UNLOCK)||(moveY>MOVE_Y_UNLOCK))
		{
			penDownPointx = -1;
			penDownPointy = -1;
			//Toast.makeText(mContext,getString(R.string.unlock_success), 1000).show();
			...
			mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, floatstreamVolume, 0);
    	        ...
    	        public void handleMessage (Message msg) {
    	             ...
    	             switch (msg.what) {
    	                 case 1:
    	            		...
    	            		mTime=DateFormat.getTimeFormat(getContext()).format(now);
    	            		//mDate=DateFormat.getDateFormat(getContext()).format(now);
    	            		//SimpleDateFormat format1 =new SimpleDateFormat("yyyy��MM��dd�� EEEE",Locale.CHINA);
    	            		SimpleDateFormat format1;
    	            		if(Locale.getDefault().getLanguage().equals("zh"))
    	            		{
    	            			format1 =new SimpleDateFormat("MM-dd-EEEE",Locale.CHINA);
 ...
 private  String BatteryV,BatteryT,BatteryStatus,BatteryStatus2,BatteryTemp;
   ...
   private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {  
       ...
       public void onReceive(Context context, Intent intent) {  
           ...
           if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {             
               ...
               chargeStatus=intent.getIntExtra("status", BatteryManager.BATTERY_STATUS_UNKNOWN);
               
               if(chargeStatus==BatteryManager.BATTERY_STATUS_CHARGING)
               {   
            	   //voltageTextView.setText("");
            	   voltageTextView.setText(df1.format(strIntVoltage)+"("+getString(R.string.charge_in)+")");
               }
               else
               {
            	   voltageTextView.setText(df1.format(strIntVoltage)+"("+getString(R.string.charge_in)+")");
  		...
  		public boolean onKeyDown(int keyCode ,KeyEvent event){
  			...
  			if(event.getKeyCode() == KeyEvent.KEYCODE_BACK)
  			{
				...
				mHomeIntent.setAction(Intent.ACTION_MAIN);
  		...
  		//���ε�Home��
  			...
  			public void onCreateContextMenu(ContextMenu menu, View v,   
  			        ...
  			        //itemIdע�ⲻҪ�ظ��������������ܵ���   
					menu.add(0, Menu.FIRST, 0, "��ɫ");   
					menu.add(0, Menu.FIRST + 1, 0, "��ɫ");   
					menu.add(0, Menu.FIRST + 2, 0, "��ɫ");   

				    //menu.add(0,Menu.FIRST,0,R.string.set_lockscreen_bg);
  			        //menu.add(0,Menu.FIRST+1,1,"����");
  			...
  			*/
  			...
  			public boolean onOptionsItemSelected(MenuItem item){
  			     ...
  			     case Menu.FIRST:
  		    		...
  		    		intent.setClass(BitmapLockScrActivity.this,galleryImage.class);
